...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="hero-unit">
		<h2>Dekripsi Caesar Cipher</h2>
			<form method="POST" action="dekrip.php" enctype="multipart/form-data">
			<table border="0">
				<tr>
					<td height="100px"><b>Masukkan File Cipher Text Anda (.txt):</b><br/>
						<input type="file" name="teks" required="required" accept=".txt" />
					</td>
				</tr>
				<tr>
					<td><input type="submit" class="btn btn-large btn-primary" type="button" value="Dekripsi!" /></td>
				</tr>
			</table>
			</form>
			<hr/>
