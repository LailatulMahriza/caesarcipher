    ...
    <div class="container">
      ...
      <div class="hero-unit">
		<h2>Enkripsi Caesar Cipher</h2>
			...
			?>
			<form method="POST" action="simpande.php" enctype="multipart/form-data">
			<table border="0">
				<tr>
					<td height="200px"><b>Cipher Text:</b><br/>
					...
					for($i=0;$i<strlen($isi);$i++) {
						for($j=0;$j<strlen($tab);$j++) {
							if($isi[$i]==$tab[$j]) {
								...
								if($cip<0) {
									$cip1 = ($cip+26)%26;
									array_push($plainarr,$tab[$cip1]);
								} else 
									array_push($plainarr,$tab[$cip]);
							}
							...
							if($isi[$i]==$tab1[$j]) {
								...
								if($cip<0) {
									$cip1 = ($cip+26)%26;
									array_push($plainarr,$tab1[$cip1]);
								} else 
									array_push($plainarr,$tab1[$cip]);
							}
							...
							if(!ctype_alpha($isi[$i])) {
								continue;
							}
						}
					}
					$plain1 = implode('',$plainarr);
				?>
				<tr>
					<td height="200px">
			...
			<table border="0">
				<tr>
					<td height="200px">
						<b>Cipher Text:</b><br/>
						<textarea name="plain" required="required" rows="9" readonly="readonly" class="input-xxlarge"><?php echo $plain1; ?></textarea>
					</td>
				</tr>
				<tr>
					<td>
